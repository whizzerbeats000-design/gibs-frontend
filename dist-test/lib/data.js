...
exports.STATIC_PAGES = exports.ENQUIRY_TYPES = exports.CAMPUS_FACILITIES = exports.ADMISSIONS_FAQS = exports.HOME_PROGRAMME_BANDS = exports.REQUIREMENTS_ACCORDION = exports.ADMISSIONS_STEPS = exports.ARTICLES = exports.INSIGHT_TYPES = exports.RESEARCH_THEMES = exports.PROGRAM_CATEGORIES = exports.PROGRAMMES = exports.FOREIGN_PROGRAMMES = exports.LOCAL_PROGRAMMES = exports.EVENTS = exports.NAV_LINKS = exports.IMAGES = exports.INTERNATIONAL = exports.ACCREDITATIONS = exports.FACULTY_DESIGNATIONS = exports.GOVERNANCE = exports.CAPACITY = exports.CAMPUSES = exports.CONTACTS = exports.INSTITUTION = exports.DATA_REQUIRED = void 0;
exports.getProgramme = getProgramme;
exports.relatedProgrammes = relatedProgrammes;
exports.getArticle = getArticle;
exports.relatedArticles = relatedArticles;
exports.DATA_REQUIRED = "[OFFICIAL GIBS DATA REQUIRED]";
exports.INSTITUTION = {
    ...
    positioning: "An outfit committed to manpower development and capacity-building. Our uniqueness is in our dedication to capacity-building exercise.",
...
exports.CAPACITY = {
    regularCapacity: "300 candidates across 6 classes of 25 participants in Workshop/Seminar formats, or up to 500 people in a single large class format per campus.",
...
exports.GOVERNANCE = {
    ...
    structure: "4 Directors under the Chairman of the Council; Management team of 20 Advisors and experts.",
};
exports.FACULTY_DESIGNATIONS = [
...
exports.PROGRAMMES = [...exports.LOCAL_PROGRAMMES, ...exports.FOREIGN_PROGRAMMES];
...
function getProgramme(slug) {
    return exports.PROGRAMMES.find((p) => p.slug === slug);
}
function relatedProgrammes(slug, count = 3) {
    const current = getProgramme(slug);
    if (!current)
        return exports.PROGRAMMES.slice(0, count);
    return exports.PROGRAMMES.filter((p) => p.slug !== slug)
        .sort((a, b) => Number(b.category === current.category) -
        Number(a.category === current.category))
        .slice(0, count);
}
/* ---------------- Research & insights ---------------- */
exports.RESEARCH_THEMES = [
    {
...
function relatedArticles(slug, count = 2) {
    const current = getArticle(slug);
    if (!current)
        return exports.ARTICLES.slice(0, count);
    return current.related
        .map((s) => exports.ARTICLES.find((a) => a.slug === s))
        .filter((a) => Boolean(a))
        .slice(0, count);
}
/* ---------------- Admissions ---------------- */
exports.ADMISSIONS_STEPS = [
    {
        n: "01",
        title: "Discover",
...
exports.REQUIREMENTS_ACCORDION = [
    {
